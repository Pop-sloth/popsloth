...
export default function FunMoodPage() {
    return (
        <main className='w-screen h-screen bg-orange-300 bg-opacity-50 flex justify-center items-end'>
            <Image
                src="/Fun5.png"
                alt='fun mood'
                width={1080}
            ...
            <Link href='/MoodTracker/moodFunShare'>
            ...
            <div id="text" className='text-center text-white h-[45vh] z-50'>
                ...
                <div id="moodTag" className='h-[10vh] flex flex-col justify-evenly mt-6'>
                    ...
                    <div id="buttomRow" className='flex justify-evenly px-[15px]'>
                        ...
                        <div id="Fun" className='h-[30px] w-[80px] bg-black rounded-[50px] flex items-center justify-center'>Fun</div>
                        </Link>
