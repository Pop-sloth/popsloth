...
export default function SadMoodPage() {
    return (
        <main className='w-screen h-screen bg-blue-500 bg-opacity-50 flex justify-center items-end'>
            <Image
                src="/Sad1.png"
                alt='Sad mood'
                width={1080}
            ...
            <Link href='/MoodTracker/moodSadShare'>
            ...
            <div id="text" className='text-center text-white h-[45vh] z-50'>
                ...
                <div id="moodTag" className='h-[10vh] flex flex-col justify-evenly mt-6'>
                    <div id="upRow" className='flex justify-evenly'>
                        ...
                        <div id="Sad" className='h-[30px] w-[80px] bg-black rounded-[50px] flex items-center justify-center'>Sad</div>
                        </Link>
                    </div>
