...
export default function RelaxMoodPage() {
    return (
        <main className='w-screen h-screen bg-[#68A973] bg-opacity-50 flex justify-center items-end'>
            <Image
                src="/Relax.png"
                alt='Relax mood'
                width={1080}
            ...
            <Link href='/MoodTracker/moodRelaxShare'>
            ...
            <div id="text" className='text-center text-white h-[45vh] z-50'>
                ...
                <div id="moodTag" className='h-[10vh] flex flex-col justify-evenly mt-6'>
                    <div id="upRow" className='flex justify-evenly'>
                        ...
                        <div id="Relax" className='h-[30px] w-[80px] bg-black rounded-[50px] flex items-center justify-center'>Relax</div>
                        </Link>
