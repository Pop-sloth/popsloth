...
export default function AngryMoodPage() {
    return (
        <main className='w-screen h-screen bg-red-600 bg-opacity-50 flex justify-center items-end'>
            <Image
                src="/Angry2.png"
                alt='Angry mood'
                width={1080}
            ...
            <Link href='/MoodTracker/moodAngryShare'>
            ...
            <div id="text" className='text-center text-white h-[45vh] z-50'>
                ...
                <div id="moodTag" className='h-[10vh] flex flex-col justify-evenly mt-6'>
                    <div id="upRow" className='flex justify-evenly'>
                        ...
                        <div id="Angry" className='h-[30px] w-[80px] bg-black rounded-[50px] flex items-center justify-center'>Angry</div>
                        </Link>
                    ...
                    <div id="buttomRow" className='flex justify-evenly px-[15px]'>
                        ...
                        <div id="Happy" className='h-[30px] w-[80px] bg-white bg-opacity-25 rounded-[50px] flex items-center justify-center'>Happy</div>
                        </Link>
